...
<img src={project.cover} alt={project.title} className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-[1.03]" loading="lazy" />
{/* Shine 효과 (MagicUI 느낌) */}
...
<div className="flex items-center gap-1 text-sm font-medium text-sky-700 dark:text-sky-300">
<span>프로젝트 설명 보기</span>
